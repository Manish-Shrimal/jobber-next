                        ...
                        <div className="row">
                            ...
                            >
                                <div className="d-flex mx-3 PageHeader">
                                    <Image width={40} height={35} unoptimized={true} src="/Images/employerSide/icon10color.png" alt="icon10" />
                                    <h3 className="mx-2">
                                ...
                                <div className="JSChangePhoto jobseekerChangePhoto mb-4 mt-5 mx-3">
                                    {picture ? (
                                        <Image width={500} height={300} unoptimized={true} src={picture} alt="profile" />
                                    ) : (
                                        <Image width={500} height={300} unoptimized={true} src="/Images/jobseekerSide/dummy-profile.png" alt="profile" />
                                    )}
                                </div>
                                <form>
