              ...
              >
                <div className="mx-3 d-flex headerMakeCV">
                  <Image
                    width={34}
                    height={34}
                    unoptimized={true} src="/Images/jobseekerSide/Make-A-CV-color.png" alt="" />
                ...
                <div className="mx-4">
                  ...
                  <div className="makeaCVBottomBotton">
                    ...
                    width={34}
                    height={34}
                    unoptimized={true} src="/Images/jobseekerSide/pdf-icon.png" alt="PDF" />{" "}
                    ...
                    width={34}
                    height={34}
                    unoptimized={true}  src="/Images/jobseekerSide/DocIcon.png" alt="Doc" />{" "}
