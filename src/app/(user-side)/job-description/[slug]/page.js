...
const Page = ({ params }) => {
  ...
  let jobSearched = localStorage.getItem("jobSearched");
  ...
  const getData = async () => {
    try {
      ...
      if (response.data.status === 200) {
        ...
        localStorage.removeItem("jobSearched");
  ...
  const handleClickWithoutLogin = () => {
    router.push("/user/jobseeker-login");
                ...
                <div className="col-lg-7 col-md-7">
                  <div className="single-job-detail">
                    ...
                    <div className="job-meta-detail">
                      ...
                      <p>
                        <FaBriefcase /> {jobDescriptiondata.experience}
                      </p>
                      <p>
                        <IoLocation /> {jobDescriptiondata.location}
                      </p>
                      <p>
                        <SlCalender /> {jobDescriptiondata.posted_date}
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="ApplyJobBtnBx">
                        ...
                        {jobDescriptiondata.is_saved === 1 ? (
                          <button className="btn btn-secondary">
                            <i className="fa fa-light fa-star-o"></i>{" "}
              ...
              <div className="row">
                <div className="col-lg-8 col-md-8">
                  <div className="JobDescriptionBx">
                    ...
                    <h2 className="mt-5">
                      {t("jobDescription.skillRequired")}
                    </h2>
                    <div>
                      {skillData.length > 0
                        ? skillData.map((i) => {
                    ...
                    <h2 className="mt-5">
                      {t("jobDescription.workingRelation")}
                    </h2>
                    <div>
                        ...
                        <ul>
                          ...
                          <li>
                            <span className="jobDescriptionKeys">
                              ...
                              {t("jobDescription.recruiterName")}:{" "}
                            </span>
                          ...
                          <li>
                            <span className="jobDescriptionKeys">
                              ...
                              {t("jobDescription.contactCompany")}:{" "}
                            </span>
                ...
                <div className="modal-body text-center">
                  ...
                  <div className="d-flex justify-content-evenly">
                    ...
                    <Link
                      ...
                      data-bs-dismiss="modal"
                      aria-label="Close"
                      onClick={() => router.push("/candidates/editprofile")}
                    >
