              ...
              >
                <div className="PHHeader PageHeader">
                  <div className="d-flex">
                    ...
                    />
                    <h3 className="mx-2">
                      {t("employerPaymentHistory.paymentHistory")}
                    </h3>
                  </div>
                          ...
                          return (
                            <>
                              <tr className="TrDefoult" key={index}>
                                ...
                                <td className="">
                                  {config.curr} {i.amount}
                                </td>
                                <td className="">{i.transaction_id}</td>
                                <td className="">
                                  {formateDate(i.start_date)}
                                </td>
                                <td className="">{formateDate(i.end_date)}</td>
                                <td className="">{formateDate(i.created)}</td>
                                  ...
                                  <div className="modals ">
                                    ...
                                    <div className="modalBody mt-4">
                                      ...
                                      <div className="row">
                                        ...
                                        <div className="col-md-4 m-2">
                                          {config.curr} {selectedPayment.amount}
                                        </div>
                                      </div>
