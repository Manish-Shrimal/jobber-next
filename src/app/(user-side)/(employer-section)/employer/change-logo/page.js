            ...
            <>
              ...
              >
                <div className="d-flex PageHeader">
                  ...
                  width={40}
                  height={40}
                  unoptimized={true} src="/Images/employerSide/icon10color.png" alt="Icon10" />
                ...
                <div className="ChangePhotoEmployers mb-4 mt-5">
                  ...
                  width={100}
                  height={100}
                  unoptimized={true} src={establishmentPhoto} alt="profile" />
                  ) : (
                    <Image
                  width={100}
                  height={100}
                  unoptimized={true} src="/Images/jobseekerSide/dummy-profile.png" alt="" />
                  )}
                </div>
                <form>
                ...
                <div className="ChangePhotoEmployers mb-4 mt-5">
                  ...
                  width={100}
                  height={100}
                  unoptimized={true} src={logo} alt="profile" />
                  ) : (
                    <Image
                  width={100}
                  height={100}
                  unoptimized={true} src="/Images/jobseekerSide/dummy-profile.png" alt="dummyimage" />
                  )}
                </div>
                <form>
                  <div className="mb-4 mt-5">
