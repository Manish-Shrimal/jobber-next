  ...
  const handleDelete = async (slug) => {
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          getData();
          router.push("/employer/manage-job");
          Swal.fire({
    ...
    for (let j = 0; j < 5; j++) {
      if (j < rating) {
        ...
        stars.push(
          ...
          // ></i>
          <BiSolidStar onClick={(event) => handleStarClick(event, j, id)} />
        );
      } else {
        stars.push(
          // <i
                ...
                <div class="JobseekerProfileBx">
                  <div class="JobseekerProfileTopBx">
                    ...
                    <span class="EditJobseekerProfileTag">
                      <Link href={`/employer/job/edit-job/${jobDetail.slug}`}>
                      <FaPencilAlt />
                      </Link>
                      <Link
                        href="#"
                        onClick={() => handleDelete(jobDetail.slug)}
                      >
                        {/* <i class="fa fa-trash" aria-hidden="true"></i> */}
                        <FaRegTrashAlt />
                      </Link>
                      <Link href={`/employer/job/copy-job/${jobDetail.slug}`}>
                        <CiFileOn />
                      </Link>
                      <Link
                        href={`/jobdescription/${jobDetail.slug}/${jobDetail.cat_slug}`}
                      >
                        <FaEye />
                      </Link>
                    ...
                    <div class="JobseekerProfileSearch">
                      <div class="Calcultn">
                        <div class="LeftSideCalu">
                          <FaSearch className="icon_calcultn" />
                        </div>
                            ...
                            <div class="JobseekersContentTop">
                              <ul>
                                <li>
                                  ...
                                  <Link href="#">{accDetail.activeJobs}</Link>
                                </li>
                                <li>
                                  <span>
                                    {t("employerInnerAccountdetail.shortlist")}
                                  </span>
                                  <Link href="#">{accDetail.shortList}</Link>
                                </li>
                                <li>
                                  <span>
                                    {t("employerInnerAccountdetail.interview")}
                                  </span>
                                  <Link href="#">{accDetail.interview}</Link>
                                </li>
                                <li>
                                  <span>
                                    {t("employerInnerAccountdetail.offer")}
                                  </span>
                                  <Link href="#">{accDetail.offer}</Link>
                                </li>
                                <li>
                                  <span>
                                    {t("employerInnerAccountdetail.accept")}
                                  </span>
                                  <Link href="#">{accDetail.accept}</Link>
                                </li>
                                <li>
                                  <span>
                                    {t(
                                  ...
                                  <Link href="#">{accDetail.notSuitable}</Link>
                                </li>
                                <li>
                                  <span>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                  <div className="d-block usernameInnerAccDetails">
                                                    <Link
                                                      href={`/candidates/profile/${i.slug}`}
                                                    >
                                                      <p
                                                        style={{
                                                          color: primaryColor,
                          ...
                          <div class="JobseekersTabsContent">
                            <div class="JobseekersTabsDetails">
                              ...
                              <div class="JobseekersTabsDetailsList">
                                ...
                                <span>
                                  <em>
                                    <Link href="#" className="btn buttonForWeb">
                                      {jobDetail.url}
                                    </Link>
                                  </em>
                                </span>
