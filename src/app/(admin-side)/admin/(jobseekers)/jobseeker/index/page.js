...
const Page = () => {
  ...
  return (
    <>
      <APNavBar />
      <div className="APBasic APManageSubadmin Page">
        <APSidebar />
          ...
          <>
            <div className="site-min-height">
              ...
              <div className="ManageSubAdminHeader">
                ...
                <button
                  className="btn navButton1 APMSbutton"
                  onClick={() => router.push("/admin/jobseeker/add-jobseeker")}
                >
                  Add Jobseeker
                </button>
                </>}
                              ...
                              <tr>
                                ...
                                {(userAccess[2]?.Edit === 1 || adminID === 1)&& <>
                                  <button
                                    ...
                                    onClick={() =>
                                      router.push(
                                        `/admin/jobseeker/edit-jobseeker/${i.slug}`
                                      )
                                    }
                                  >
                                    <Tooltip title="Edit">
                                  ...
                                  <button
                                    ...
                                    onClick={() =>
                                      router.push(
                                        `/admin/jobseeker/certificates/${i.slug}`
                                      )
                                    }
                                  >
                                  ...
                                  <button
                                    className="btn btn-primary"
                                    onClick={() =>
                                      router.push(`/admin/jobseeker/applied/${i.slug}`)
                                    }
                                  >
