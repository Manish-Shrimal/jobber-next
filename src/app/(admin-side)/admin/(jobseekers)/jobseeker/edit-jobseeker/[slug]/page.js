    ...
    try {
      ...
      if (confirmationResult.isConfirmed) {
        ...
        if (response.data.status === 200) {
          ...
          router.push("/admin/jobseeker-list");
        } else {
          Swal.fire({
              ...
              <div className="breadCumb" role="presentation">
                ...
                >
                  ...
                  <Link
                    underline="hover"
                    color="inherit"
                    onClick={() => router.push("/admin/jobseeker-list")}
                  >
                    Jobseeker
                  </Link>
              ...
              <form className="adminForm">
                <div className="mb-4 mt-5">
                  ...
                  <div class="mb-5 DashBoardInputBx">
                    ...
                    <div id="emailHelp" class="form-text">
                      * Note: If You want to change User&apos;s password, only
                      then fill password below otherwise leave it blank.
                    </div>
                  </div>
                  <div class="mb-5 DashBoardInputBx">
                    <label for="formFile" class="form-label">
                  ...
                  <div className="otherSection">
                    ...
                    <div id="emailHelp" className="form-text">
                      Click above to change Employer&apos;s status. Changes will
                      be reflect only after submitting form.
                    </div>
