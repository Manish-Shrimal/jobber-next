                        ...
                        <input type="checkbox" />
                            ...
                            <div className="cardLower">
                              <div className="cardLowerImg">
                                <Image width={40} height={40} unoptimized={true}  alt="New icon for admin panel"  src="/Images/adminpanel/new.png" />
                              </div>
                    ...
                    <>
                      <div className="col-md-3">
                        ...
                        <input type="checkbox" />
                            ...
                            <div className="cardLower">
                              <div className="cardLowerImg">
                                <Image width={40} height={40} unoptimized={true}  alt="Jobseeker icon" src="/Images/adminpanel/Jobseeker.png" />
                              </div>
                              {/* <div className="cardLowerTxt">
                          <p>
                            10.2
                    ...
                    <>
                      <div className="col-md-3">
                        ...
                        <input type="checkbox" />
                            ...
                            <div className="cardLower">
                              <div className="cardLowerImg">
                                <Image width={40} height={40} unoptimized={true}  alt="Jobs icon" src="/Images/adminpanel/Jobs.png" />
                              </div>
                              {/* <div className="cardLowerTxt">
                          <p>
                            10.2
                    ...
                    <>
                      <div className="col-md-3">
                        ...
                        <input type="checkbox" />
                            ...
                            <div className="cardLower">
                              <div className="cardLowerImg">
                                <Image width={40} height={40} unoptimized={true}  alt="Skill icon" src="/Images/adminpanel/Skills.png" />
                              </div>
                              {/* <div className="cardLowerTxt">
                          <p>
                            10.2
                    ...
                    <div className="dashboardSection3 manageSubadminPart2">
                      <div className="tableHeader">
                        ...
                        <button
                          ...
                          onClick={() => router.push("/admin/employer-list")}
                        >
                          View All
                        </button>
                      </div>
                      <table className="table">
                        <thead>
                          <tr>
                            ...
                            <th
                              onClick={() => handleColumnClick("company_name")}
                            >
                              Company Name {symbol}
                            </th>
                            ...
                            <th
                              onClick={() => handleColumnClick("current_plan")}
                            >
                              Current Plan {symbol}
                            </th>
                                    ...
                                    {(userAccess[0]?.Edit === 1 ||
                                      ...
                                      <>
                                        <button
                                          ...
                                          onClick={() =>
                                            router.push(
                                              `/admin/employer-list/edit-employer/${i.slug}`
                                            )
                                          }
                                        >
                                          {/* <Tooltip title="Edit"> */}
