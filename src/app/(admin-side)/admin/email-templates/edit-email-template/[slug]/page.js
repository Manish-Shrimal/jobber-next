      ...
      if (Object.keys(newErrors).length === 0) {
        ...
        if (confirmationResult.isConfirmed) {
          ...
          if (response.data.status === 200) {
            ...
            // });
            // window.scrollTo(0, 0);
            router.push("/admin/email-templates/index");
          } else {
            Swal.fire({
            ...
            <div className="site-min-height">
              <div className="breadCumb1" role="presentation">
                ...
                >
                  ...
                  <Link
                    href="/admin/email-templates/index"
                    underline="hover"
                    color="inherit"
                  >
              ...
              <form>
                <div className="mb-4 mt-5">
                  ...
                  <div className="firstBlockEmailTemplate">
                    <div class="mb-5 DashBoardInputBx">
                      ...
                      {Object.entries(variables)?.map(([key, value]) => {
                        return (
                          <div className="APEditEmailTemplateButtons" key={key}>
                            <button
                  ...
                  <button
                    ...
                    onClick={() => router.push("/admin/email-templates/index")}
                  >
                    CANCEL
                  </button>
                </div>
